...
public let ARC_WIDTH = CGFloat(4)
...
public let MAIN_NODE_ROTATION_INCREMENT = CGFloat(0.045/60)
public var MAIN_NODE_ROTATION_ORIGINAL = CGFloat(25/60)
